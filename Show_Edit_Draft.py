...
class View_Draft(QMainWindow):
    def __init__(self):
        super().__init__()
     
        #QMainWindow().__init__(self,parent)
        #self.parent = parent
        self.setWindowTitle("Free Agents")
        ...
        self.model.setTable("free_agents")
        self.model.setEditStrategy(QSqlTableModel.OnManualSubmit)
        self.model.setHeaderData(0, Qt.Horizontal, "ID")  # Set header for the first column
        self.model.setHeaderData(1,Qt.Horizontal,"Name")
        self.model.setHeaderData(2,Qt.Horizontal,"Pos")
        self.model.setHeaderData(3,Qt.Horizontal,"Ht")
        self.model.setHeaderData(4,Qt.Horizontal,"Wt")
        self.model.setHeaderData(5,Qt.Horizontal,"Yrs")
        self.model.setHeaderData(6,Qt.Horizontal,"Spd")
        self.model.setHeaderData(7,Qt.Horizontal,"Run")
        self.model.setHeaderData(8,Qt.Horizontal,"Rcv")
        self.model.setHeaderData(9,Qt.Horizontal,"Pass")
        self.model.setHeaderData(10,Qt.Horizontal,"Kick")
        self.model.setHeaderData(11,Qt.Horizontal,"Blk")
        self.model.select()
