...
class View_Conferences(QMainWindow):
    def __init__(self):
        super().__init__()
     
        #QMainWindow().__init__(self,parent)
        #self.parent = parent
        self.setWindowTitle("pyNFL Conferences")
        ...
        self.model.setHeaderData(0, Qt.Horizontal, "Code")  # Set header for the first column
        self.model.setHeaderData(1,Qt.Horizontal,"Name")
        self.model.setHeaderData(2,Qt.Horizontal,"Abbr")
        self.model.select()
